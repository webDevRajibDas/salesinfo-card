...
@section('content')
    <div class="intro-slider-container">
        <div class="intro-slider owl-carousel owl-simple owl-nav-inside" data-toggle="owl" data-owl-options='{
            ...
            <div class="intro-slide"
                 style="background-image: url(ecommerce-theme/assets/images/demos/demo-13/slider/slide-1.png);">
            ...
            <div class="intro-slide"
                 style="background-image: url(ecommerce-theme/assets/images/demos/demo-13/slider/slide-2.jpg);">
                <div class="container intro-content">
                    <div class="row">
                        <div class="col-auto offset-lg-3 intro-col">
            ...
            <div class="intro-slide"
                 style="background-image: url(ecommerce-theme/assets/images/demos/demo-13/slider/slide-3.jpg);">
                <div class="container intro-content">
                    <div class="row">
                        <div class="col-auto offset-lg-3 intro-col">
            ...
            <div class="row">
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                                    <span>
                                        <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/cats/1.jpg')}}"
                                             alt="Category image">
                                    </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                                    <span>
                                        <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/cats/2.jpg')}}"
                                             alt="Category image">
                                    </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                                    <span>
                                        <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/cats/3.jpg')}}"
                                             alt="Category image">
                                    </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                                    <span>
                                        <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/cats/4.jpg')}}"
                                             alt="Category image">
                                    </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                                    <span>
                                        <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/cats/5.jpg')}}"
                                             alt="Category image">
                                    </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                                    <span>
                                        <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/cats/6.jpg')}}"
                                             alt="Category image">
                                    </span>
                        </figure>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="banner banner-overlay">
                    <a href="#">
                        <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/banners/banner-1.jpg')}}"
                             alt="Banner">
                    </a>
                    ...
                    <div class="banner-content">
                        ...
                        <!-- End .banner-subtitle -->
                        <h3 class="banner-title text-white"><a href="#">Lighting <br>& Accessories
                                <br><span>25% off</span></a></h3><!-- End .banner-title -->
            ...
            <div class="col-sm-6 col-lg-3 order-lg-last">
                <div class="banner banner-overlay">
                    <a href="#">
                        <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/banners/banner-3.jpg')}}"
                             alt="Banner">
                    </a>
            ...
            <div class="col-lg-6">
                <div class="banner banner-overlay">
                    <a href="#">
                        <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/banners/banner-2.jpg')}}"
                             alt="Banner">
                    </a>
                    ...
                    <div class="banner-content">
                        ...
                        <!-- End .banner-subtitle -->
                        <h3 class="banner-title text-white"><a href="#">Clothes Trending <br>Spring Collection 2019 <br><span>from $12,99</span></a>
                        </h3><!-- End .banner-title -->
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        ...
                        <div class="product">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="{{asset('ecommerce-theme/assets/images/products/product-1.jpg')}}"
                        ...
                        <div class="product">
                            <figure class="product-media">
                                ...
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="{{asset('ecommerce-theme/assets/images/products/product-2.jpg')}}"
                                         alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product">
                            <figure class="product-media">
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="{{asset('ecommerce-theme/assets/images/products/product-3.jpg')}}""
                                    alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product">
                            <figure class="product-media">
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="{{asset('ecommerce-theme/assets/images/products/product-4.jpg')}}"
                                         alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product">
                            <figure class="product-media">
                                ...
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="{{asset('ecommerce-theme/assets/images/products/product-5.jpg')}}"
                                         alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-6.jpg')}}"
                                         alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        ...
                        <div class="product">
                            <figure class="product-media">
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-4.jpg')}}"
                                         alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product">
                            <figure class="product-media">
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-1.jpg')}}"
                                         alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product">
                            <figure class="product-media">
                                ...
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-2.jpg')}}"
                                         alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product">
                            <figure class="product-media">
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-3.jpg')}}"
                                         alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product">
                            <figure class="product-media">
                                ...
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-5.jpg')}}"
                                         alt="Product image" class="product-image">
                                </a>
            ...
            <div class="tab-pane p-0 fade" id="elec-featured-tab" role="tabpanel" aria-labelledby="elec-featured-link">
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-8.jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
                ...
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <span class="product-label label-sale">Sale</span>
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-10.jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <span class="product-label label-new">New</span>
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-9.jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
            ...
            <div class="col-lg-6">
                <div class="banner banner-overlay">
                    ...
                    <div class="banner-content">
                        <h4 class="banner-subtitle text-white  d-none d-sm-block"><a href="#">Amazing Value</a></h4>
                        <!-- End .banner-subtitle -->
                        <h3 class="banner-title text-white"><a href="#">Headphones Trending <br>JBL Harman <br><span>from $59,99</span></a>
                        </h3><!-- End .banner-title -->
                        <a href="#" class="banner-link">Discover Now <i class="icon-long-arrow-right"></i></a>
                    </div><!-- End .banner-content -->
                </div><!-- End .banner -->
                ...
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <span class="product-label label-new">New</span>
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-11.jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-12.jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <span class="product-label label-sale">Sale</span>
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-13.jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-14.jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <span class="product-label label-sale">Sale</span>
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-15.jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
            ...
            <div class="tab-pane p-0 fade" id="furn-featured-tab" role="tabpanel" aria-labelledby="furn-featured-link">
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-512jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
            ...
            <div class="tab-pane p-0 fade show active" id="clot-new-tab" role="tabpanel"
                ...
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-16.jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <span class="product-label label-new">New</span>
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-17.jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-18.jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-19.jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-20.jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
            ...
            <div class="tab-pane p-0 fade" id="clot-featured-tab" role="tabpanel" aria-labelledby="clot-featured-link">
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/products/product-518jpg')}}"
                                     alt="Product image" class="product-image">
                            </a>
    ...
    <div class="container">
        ...
        <div class="owl-carousel mb-5 owl-simple" data-toggle="owl"
            ...
            <a href="#" class="brand">
                <img src="{{asset('ecommerce-theme/assets/images/brands/1.png')}}" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="{{asset('ecommerce-theme/assets/images/brands/2.png')}}" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="{{asset('ecommerce-theme/assets/images/brands/3.png')}}" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="{{asset('ecommerce-theme/assets/images/brands/4.png')}}" alt="Brand Name">
            </a>
            ...
            <div class="owl-carousel owl-simple" data-toggle="owl"
                ...
                <article class="entry">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/blog/post-1.jpg')}}"
                                 alt="image desc">
                        </a>
                ...
                <article class="entry">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/blog/post-2.jpg')}}"
                                 alt="image desc">
                        </a>
                    </figure><!-- End .entry-media -->
                ...
                <article class="entry">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/blog/post-3.jpg')}}"
                                 alt="image desc">
                        </a>
                    </figure><!-- End .entry-media -->
                ...
                <article class="entry">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{asset('ecommerce-theme/assets/images/demos/demo-13/blog/post-4.jpg')}}"
                                 alt="image desc">
                        </a>
                    </figure><!-- End .entry-media -->
