                ...
                <div class="card card-modern">
                    <div class="card-body py-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 col-md-4 border border-top-0 border-right-0 border-bottom-0 border-color-light-grey py-3">
                                <h3 class="text-4-1 text-color-danger line-height-2 my-0">Price <strong>DOWN
                                        ↓</strong></h3>
                                <span>30 days</span>
                            </div>
                            <div class="col-md-4 text-left text-md-right pr-md-4 mt-4 mt-md-0">
                ...
                <ul class="list list-unstyled mb-0">
                    <li class="activity-item">
                        ...
                        <span class="activity-description">
                                    ...
                                    href="#" class="text-color-dark"><strong>Black Watch</strong></a> to Cart.
											</span>
                    </li>
                    <li class="activity-item">
                    ...
                    <li class="activity-item">
                        ...
                        <span class="activity-description">
                                    ...
                                    href="#" class="text-color-dark"><strong>Porto SmartWatch</strong></a> to Cart.
											</span>
                    </li>
                    <li class="activity-item">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-ecommerce-simple table-striped mb-1">
                        ...
                        <tbody>
                        <tr>
                            <td width="72"><a href="#"><img src="images/product-1.jpg" class="img-fluid"
                                                            width="45" alt="Porto SmartWatch"></a></td>
                            <td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
                            <td width="90">$15</td>
                        </tr>
                        <tr>
                            <td><a href="#"><img src="images/product-2.jpg" class="img-fluid" width="45"
                                                 alt="Porto SmartWatch"></a></td>
                            <td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
                            <td>$15</td>
                        </tr>
                        <tr>
                            <td><a href="#"><img src="images/product-3.jpg" class="img-fluid" width="45"
                                                 alt="Porto SmartWatch"></a></td>
                            <td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
                            <td>$15</td>
                        </tr>
                        <tr>
                            <td><a href="#"><img src="images/product-4.jpg" class="img-fluid" width="45"
                                                 alt="Porto SmartWatch"></a></td>
                            <td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
                            <td>$15</td>
                        </tr>
                        <tr>
                            <td><a href="#"><img src="images/product-5.jpg" class="img-fluid" width="45"
                                                 alt="Porto SmartWatch"></a></td>
                            <td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
                            <td>$15</td>
                        </tr>
                ...
                <div class="datatables-header-footer-wrapper">
                    ...
                    <table class="table table-ecommerce-simple table-striped mb-0"
                        ...
                        <tr>
                            ...
                            <td><a href="ecommerce-orders-detail.html"><strong>Customer Name Example
                                        2</strong></a></td>
                            <td>Nov 22, 2019</td>
                            <td>$70</td>
                            <td><span class="ecommerce-status on-hold">On Hold</span></td>
